...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#1e1f22] text-gray-300 flex flex-row">
        {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-75 z-50 flex items-center justify-center">
          <div className="bg-[#282b30] rounded-lg p-6 w-full max-w-2xl">
            ...
            <div className="flex gap-4 mt-4 border-t border-gray-700 pt-4">
              <a href="#" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#40444b] text-gray-300 font-semibold transition-colors cursor-pointer hover:bg-[#52575e]">
              ...
              <a href="#" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#40444b] text-gray-300 font-semibold transition-colors cursor-pointer hover:bg-[#52575e]">
                <TagIcon className="w-6 h-6 text-purple-500" /> tags
              </a>
              <a href="#" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#40444b] text-gray-300 font-semibold transition-colors cursor-pointer hover:bg-[#52575e]">
      ...
      {/* Main Feed with floating post prompt */}
            ...
            >
              ...
              <div className="flex gap-4 mt-4 border-t border-gray-700 pt-4">
                ...
                <div className="relative">
                  ...
                  {openPostId === post.id && (
                    <div className="absolute bottom-full right-0 mb-2 flex flex-col gap-2 bg-[#40444b] p-2 rounded-lg">
